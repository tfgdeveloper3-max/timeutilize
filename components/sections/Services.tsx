  ...
  return (
    <section ref={sectionRef} className="py-32 max-w-7xl mx-auto px-6 relative overflow-hidden">
      ...
      <div className="service-header flex flex-col md:flex-row justify-between items-start mb-20 gap-8 relative z-10">
        <div>
          <p className="text-xs tracking-widest uppercase text-white/40 font-mono mb-4 backdrop-blur-sm">
            Core Capabilities
          </p>
          <h2 className="text-4xl md:text-6xl font-black tracking-tighter text-white leading-none">
            The full spectrum<br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-400 italic">of core capabilities</span>
          </h2>
        </div>
        <p className="max-w-sm text-white/50 text-base leading-relaxed backdrop-blur-sm">
        ...
        {services.map((s, index: number) => (
          ...
          >
            ...
            <div className="absolute inset-0 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"
              style={{
                background: `radial-gradient(circle at 30% 30%, ${s.color}20, transparent 50%)`,
              }}
            ></div>

            {/* Glass morphism card */}
            <div className="relative backdrop-blur-xl bg-white/[0.08] border border-white/[0.15] rounded-2xl p-8 md:p-10 
              hover:bg-white/[0.12] hover:border-white/[0.25] 
              transition-all duration-500 cursor-pointer
              group-hover:shadow-2xl"
              style={{
                boxShadow: hoveredCard === index
                  ? `0 0 40px ${s.color}40, 0 0 80px ${s.color}20`
            ...
            >
              ...
              <div className="relative z-10">
                <div className="flex justify-between items-start mb-8">
                  <span className="text-xs font-mono text-white/40 tracking-widest group-hover:text-white/60 transition-colors duration-300">
                    {s.number}
                  </span>
                  <span className="text-white/30 group-hover:text-white group-hover:translate-x-2 group-hover:-translate-y-2 
                    transition-all duration-300 text-xl"
                    style={{
                      color: hoveredCard === index ? s.color : 'inherit'
                    }}
                  >
                    ↗
                  </span>
              ...
              <div className="absolute bottom-0 left-0 h-1 w-0 group-hover:w-full rounded-full transition-all duration-500"
